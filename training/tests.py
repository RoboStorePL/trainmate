...
class TrainMateTests(TestCase):
    ...
    def test_client_cannot_manage_catalog(self):
    ...
    def test_trainer_can_manage_only_own_sessions(self):
    ...
    def test_superuser_can_manage_catalog(self):
    ...
    def test_only_superuser_can_view_clients(self):
