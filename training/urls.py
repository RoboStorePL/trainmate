...
urlpatterns = [
    ...
    path("payouts/earnings/<int:pk>/correct/", views.SalaryAdjustmentCreate.as_view(), name="salary-adjustment-create"),
    path("payouts/<int:pk>/", views.TrainerPayoutDetail.as_view(), name="trainer-payout-detail"),
